...
const LS_Projects = "project_manager_v1"
const LS_Tasks = "project_manager_tasks_v1"
    ...
    return (
        <div className="board">
            ...
            <div className='column'>
                <h2>Not started</h2>
                <div className='task-card'> Set up project repo</div>
            </div>

            <div className='column'>
                <h2>In Progress</h2>
                <div className='task-card'>Design Kanban layout</div>
            </div>

            <div className='column'>
                <h2>Completed</h2>
                <div className='task-card'>Create task card component</div>
            </div>
        </div>
    );
}